...
int main()
{
	...
	eksperyment(sortowanie_szybkie_start_modyf,  "Sortowanie Szybkie zmodyfikowane", output);
	eksperyment(sortowanie_przez_wstawianie, "Sortowanie przez wstawianie", output);
